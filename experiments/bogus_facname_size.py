...
output += struct.pack(">I", 0)  # total memory

output += struct.pack(">H", 0)  # offset
output += b'testAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\x00'
...
with open('bogus_facname_size.lxt', 'wb') as f:
    f.write(output)
