...
block_data += struct.pack(">B", 128)   # num_time_table_entries
for _ in range(128):
    block_data += struct.pack(">Q", 0xdeadbeef)
...
with open('bogus_oversize_granule.lxt2', 'wb') as f:
    f.write(output)
