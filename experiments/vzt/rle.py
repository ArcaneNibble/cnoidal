...
# waveforms here
block_data += varint(1) + varint(3) + varint(28)
block_data += varint(2) + varint(1) + varint(29)
block_data += varint(3) + varint(1) + varint(28)
block_data += varint(1) + varint(1) + varint(30)
